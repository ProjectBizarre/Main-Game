    ...
    if (data.rojoConfigPath !== undefined) {
        for (const partition of rojoResolver.getPartitions()) {
            for (const rootDir of rootDirs) {
                if (isPathDescendantOf_1.isPathDescendantOf(partition.fsPath, rootDir)) {
                    ...
                    DiagnosticService_1.DiagnosticService.addDiagnostic(diagnostics_1.warnings.rojoPathInSrc(inputPath, suggestedPath));
                }
            }
        }
    }
