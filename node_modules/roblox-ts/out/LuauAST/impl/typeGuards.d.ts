...
export declare const isAnyIdentifier: (node: luau.Node) => node is luau.Identifier | luau.EmptyIdentifier | luau.TemporaryIdentifier;
export declare const isIdentifier: (node: luau.Node) => node is luau.Identifier;
export declare const isEmptyIdentifier: (node: luau.Node) => node is luau.EmptyIdentifier;
...
export declare const isArray: (node: luau.Node) => node is luau.Array<luau.Expression<keyof luau.ExpressionByKind>>;
...
export declare const isSimple: (node: luau.Node) => node is luau.Identifier | luau.EmptyIdentifier | luau.TemporaryIdentifier | luau.NilLiteral | luau.FalseLiteral | luau.TrueLiteral | luau.NumberLiteral | luau.StringLiteral;
...
export declare const isTable: (node: luau.Node) => node is luau.Array<luau.Expression<keyof luau.ExpressionByKind>> | luau.Map | luau.Set;
