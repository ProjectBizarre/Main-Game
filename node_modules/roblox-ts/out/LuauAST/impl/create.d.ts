...
export declare function emptyId(): luau.EmptyIdentifier;
...
export declare function array(members?: Array<luau.Expression>): luau.Array<luau.Expression<keyof luau.ExpressionByKind>>;
