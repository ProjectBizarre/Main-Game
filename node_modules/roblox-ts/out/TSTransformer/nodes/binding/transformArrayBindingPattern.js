...
function transformArrayBindingPattern(state, bindingPattern, parentId) {
    ...
    const accessor = getAccessorForBindingType_1.getAccessorForBindingType(state, bindingPattern, state.getType(bindingPattern));
        ...
        if (byots_1.default.isOmittedExpression(element)) {
            ...
            if (byots_1.default.isIdentifier(name)) {
                ...
                if (byots_1.default.isArrayBindingPattern(name)) {
                    ...
                    transformObjectBindingPattern_1.transformObjectBindingPattern(state, name, id);
                }
            }
        }
        index++;
