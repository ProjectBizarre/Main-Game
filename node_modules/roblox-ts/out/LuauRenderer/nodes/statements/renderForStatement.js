...
function renderForStatement(state, node) {
    const idsStr = LuauAST_1.default.list.mapToArray(node.ids, id => LuauRenderer_1.render(state, id)).join(", ") || "_";
    const expStr = LuauRenderer_1.render(state, node.expression);
    let result = "";
