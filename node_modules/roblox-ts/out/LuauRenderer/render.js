...
const renderEmptyIdentifier_1 = require("./nodes/expressions/indexable/renderEmptyIdentifier");
...
const KIND_TO_RENDERER = byots_1.default.identity({
    [LuauAST_1.default.SyntaxKind.Identifier]: renderIdentifier_1.renderIdentifier,
    [LuauAST_1.default.SyntaxKind.EmptyIdentifier]: renderEmptyIdentifier_1.renderEmptyIdentifier,
...
function renderAST(ast) {
    ...
    solveTempIds_1.solveTempIds(state, ast);
    return renderStatements_1.renderStatements(state, ast);
}
