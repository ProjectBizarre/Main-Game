...
var SymbolProvider = /** @class */ (function () {
    ...
    SymbolProvider.prototype.registerFileSymbol = function (file) {
        ...
        logger_1.Logger.writeLineIfVerbose("Registering " + name);
    ...
    SymbolProvider.prototype.isFileInteresting = function (file) {
        ...
        if (this.flameworkDir && isPathDescendantOf_1.isPathDescendantOf(file.fileName, this.flameworkDir)) {
            return true;
        }
        if (this.componentsDir && isPathDescendantOf_1.isPathDescendantOf(file.fileName, this.componentsDir)) {
            return true;
        }
        if (this.networkingDir && isPathDescendantOf_1.isPathDescendantOf(file.fileName, this.networkingDir)) {
            return true;
        }
        return false;
    };
    SymbolProvider.prototype.finalize = function () {
        ...
        if (!this.flameworkFile.namespaces.has("Flamework") ||
            ...
            throw logger_1.Logger.writeLine("" + chalk_1.default.red("Failed to load! Symbols were not populated"), "This is commonly caused by a TS version mismatch.", "It is recommended that you use a local install of roblox-ts.", "You can install a local version using " + chalk_1.default.green("npm install -D roblox-ts"));
        }
        ...
        this.networkingImpl = (_c = this.networkingFile) === null || _c === void 0 ? void 0 : _c.getNamespace("NetworkingImpl");
    };
